THREE.orbitControls = function( camera, scalex, scaley, scene, domElement) {
	
	var _this = this;
	
	this.object = new THREE.Object3D();
	this.object.name = camera.id + 'Pivot';
	this.scene = scene;
	...
	this.updatePanning = function () {
		...
		_this.direction.applyEuler(_this.object.rotation, _this.object.rotation.order);
